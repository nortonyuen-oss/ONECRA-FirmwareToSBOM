...
| `v1.23.0` | Intel CPU microcode 列為元件;格式描述 `fw2sbom:detected_format`(取代 Windows 上沒有的 `file(1)`) |
...
| 測試 | 346 個。26 個合成 fixture + 公開格式樣本 + 真實韌體 corpus(OpenWrt 4 份、GL.iNet、3 份 ESP32、OVMF) |
