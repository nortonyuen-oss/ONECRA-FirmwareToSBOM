...
| 項目 | 狀態 |
|---|---|
| 程式碼 | 約 8,700 行,9 個模組 + 6 個簽章包(36 個簽章) |
| 依賴 | 無。Python 3.9+ 標準函式庫 |
| 測試 | 133 個。10 個合成 fixture + 1 份真實廠商韌體 corpus |
...
Phase 3 剩餘:ESP32(`0xE9` image header)、raw 映像的 RISC-V / Xtensa 指令集
辨識(ELF 輸入已經涵蓋)。之後:Phase 4(UEFI)。
